/** Numéro d'assistance, au format international sans « + » pour wa.me. */
const PHONE = "22670613303";
const LABEL = "Contacter l'assistance sur WhatsApp";

/** Bouton flottant d'accès direct à l'assistance WhatsApp. */
